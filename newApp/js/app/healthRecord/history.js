    ...
    var vueApp = new Vue({
        ...
        methods: {
            init: function () {
                ...
                var option = {
                    url:"health/list",
                    data: {'review_type':'health_history'},
                    type: 'post',
                ...
                common.ajax({option:option,isLoding:1,isNew:1,isRefresh:{"fn":vueApp.init}});
            },
            chooseItem: function (id,name) {
                app.pop({"name":'healthRecord/historyQuestions.html?review_id='+id,"id":"healthRecord_historyQuestions","titleNView":{
						"titleText":name
					}});
            },
